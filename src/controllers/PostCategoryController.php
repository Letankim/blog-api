   ...
   public function getAll(Request $request, Response $response): Response
{
    ...
    public function getById(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            $category = $this->model->getByIdPostCategory($id);
            if (!$category) {
    ...
    public function create(Request $request, Response $response): Response
    {
        try {
            ...
            $result = $this->model->createPostCategory($data);
    ...
    public function update(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            ...
            $result = $this->model->updatePostCategory($id, $data);
    ...
    public function delete(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            $result = $this->model->deletePostCategory($id);
            return $this->jsonResponse($response, 200, $result);
        } catch (\Exception $e) {
            return $this->jsonResponse($response, 400, ['error' => $e->getMessage()]);
        }
